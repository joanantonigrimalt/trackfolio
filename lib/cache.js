...
const MAX_STALE_DAYS = 4; // re-fetch if last data point is older than this (4 days covers weekends safely) // re-fetch if last data point is older than this
...
// Escrituras a las tablas de caché: usa la service-role key si está disponible.
// Permite bloquear la escritura anónima en RLS (evita envenenamiento de caché por terceros).
// Fallback a la anon key si no se ha configurado → no rompe entornos antiguos.
